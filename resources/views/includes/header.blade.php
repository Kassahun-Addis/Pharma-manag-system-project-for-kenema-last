<!-- Header -->
<div class="header">
		<!--<h6>ከነማ የህዝብ መድሐኒት ቤት Kenema public pharmacy</h6>	-->
	<!-- Logo -->
	 <div class="header-left">
		<a href="{{route('dashboard')}}" class="logo">
			...
			<img src="@if(!empty(AppSettings::get('logo'))) {{asset('storage/'.AppSettings::get('logo'))}} @else{{asset('assets/img/pharma-logo.jpg')}} @endif" alt="logo here">
		</a>
		<a href="{{route('dashboard')}}" class="logo logo-small">
			<img src="{{asset('assets/img/pharma-logo.jpg')}}" alt="Logo" width="30" height="30">
	...
	<a href="javascript:void(0);" id="toggle_btn">
    <i class="fe fe-text-align-left"></i>
    <span style="font-weight: bold;margin-left: 80px;color: blue;font-weight: bold;">Kenema public pharmacy managment system</span>
    </a>
	...
	<ul class="nav user-menu">
		...
		<li class="nav-item dropdown has-arrow">
			<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
				<span class="user-img"><img class="rounded-circle" src="@if(!empty(auth()->user()->avatar)){{asset('storage/users/'.auth()->user()->avatar)}}@endif" width="31" alt="No image here"></span>
			</a>
