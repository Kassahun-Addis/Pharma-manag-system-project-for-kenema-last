		...
		<div id="sidebar-menu" class="sidebar-menu">
			...
			<ul>
				...
				<li class="{{ Request::routeIs('dashboard') ? 'active' : '' }}"> 
					<a href="{{route('dashboard')}}"><i class="fe fe-home"></i> <span>Home</span></a>
				</li>
				...
				<li class="submenu">
					...
					<ul style="display: none;">
						<li><a class="{{ Request::routeIs('suppliers') ? 'active' : '' }}" href="{{route('suppliers')}}">View Supplier</a></li>
				...
				<li class="submenu">
					...
					<ul style="display: none;">
						<li><a class="{{ Request::routeIs('purchases') ? 'active' : '' }}" href="{{route('purchases')}}">View Purchase</a></li>
						@can('create-purchase')
				...
				<li class="submenu">
					...
					<ul style="display: none;">
						@can('view-products')<li><a class="{{ Request::routeIs(('products')) ? 'active' : '' }}" href="{{route('products')}}">View Products</a></li>@endcan
						@can('create-product')<li><a class="{{ Request::routeIs('add-product') ? 'active' : '' }}" href="{{route('add-product')}}">Add Product</a></li>@endcan
						@can('view-outstock-products')<li><a class="{{ Request::routeIs('outstock') ? 'active' : '' }}" href="{{route('outstock')}}">Out-Stock Products</a></li>@endcan
						@can('view-expired-products')<li><a class="{{ Request::routeIs('expired') ? 'active' : '' }}" href="{{route('expired')}}">View Expired Products</a></li>@endcan
					</ul>
				</li>
				@endcan
              ...
              <!--  Modified by me instead of below  
				...
				<li class="submenu">
					...
					<ul style="display: none;">
						<li><a class="{{ Request::routeIs('sales') ? 'active' : '' }}" href="{{route('sales')}}">View sales</a></li>
						@can('create-sales')
						<li><a class="{{ Request::routeIs('sales') ? 'active' : '' }}" href="{{route('sales')}}">Add sales</a></li>
						@endcan
					</ul>
				</li>
				@endcan
				...
				<li class="submenu">
					...
					<ul style="display: none;">
						<li><a class="{{ Request::routeIs('reports') ? 'active' : '' }}" href="{{route('reports')}}">Generate Reports</a></li>
					</ul>
				</li>
				@endcan
